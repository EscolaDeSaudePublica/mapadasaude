                        ...
                        <div ng-if="field.fieldType !== 'file'">
                            ...
                            <div ng-if="field.fieldType === 'file'">
                                ...
                                <input type="text" ng-model="field.title" placeholder="<?php i::esc_attr_e("Nome do anexo");?>"/>
                                    ...
                                    <p>
                                        <label><input type="checkbox" ng-model="field.required" ng-checked="field.required"> <small><?php i::_e("O envio deste anexo é obrigatório");?></small></label><br>
                                        <label><input type="checkbox" ng-model="field.multiple" ng-checked="field.multiple"> <small><?php i::_e("Aceitar multiplos arquivos");?></small></label>
                                    </p>
